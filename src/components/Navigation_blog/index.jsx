...
import {IoLogoGithub, IoIosMail, IoLogoLinkedin, IoIosGift} from 'react-icons/io'
import './assets/style.scss'


const Navigation_blog = props => {
    return (
        <div className='navigation_blog'>
            <Navbar expand="md">
...
export default Navigation_blog